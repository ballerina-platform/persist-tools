...
public class BalFileConstants {
    ...
    public static final String FIELD_ACCESSS_STRING = ".";
    public static final String ARRAY_TYPE_STRING = "[]";
    public static final String START_CLOSED_RECORD_STRING = "{|";
    public static final String END_CLOSED_RECORD_STRING = "|}";
    public static final String START_RECORD_STRING = "{";
    public static final String END_RECORD_STRING = "}";
