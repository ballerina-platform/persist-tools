                ...
                if (field.getRelation() != null) {
                    ...
                    if (field.getRelation().isOwner()) {
                        ...
                        for (Relation.Key key : field.getRelation().getKeyColumns()) {
                            ...
                            foreignKeyFields.append(String.format(RedisSyntaxConstants.METADATA_RECORD_FIELD_TEMPLATE,
                                    key.getField(), BalSyntaxUtils.stripEscapeCharacter(key.getField()), getDataTypeInAllCaps(field.getFieldType())));
                        }
                    }
