...
import static io.ballerina.persist.tools.ToolingTestUtils.GENERATED_SOURCES_DIRECTORY;
import static io.ballerina.persist.tools.ToolingTestUtils.generateSourceCode;
...
public class DatabaseTestUtils {
    ...
    public static void assertCreateDatabaseTables(String subDir, ArrayList<PersistTable> tables) {
        ...
        HashMap configurations = generateSourceCode(Paths.get(GENERATED_SOURCES_DIRECTORY, subDir), DBPUSH);
