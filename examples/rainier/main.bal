...
public function main() returns error? {
    ...
    io:println("\n========== Workspace ==========");
    _ = check from rainier:Workspace workspace in rainierClient->/workspaces.get()
        do {
            io:println(workspace);
        };
    io:println("\n========== Department ==========");
    _ = check from rainier:Department department in rainierClient->/departments.get()
        do {
            io:println(department);
        };
    io:println("\n========== Employee ==========");
    _ = check from rainier:Employee employee in rainierClient->/employees.get()
        do {
            io:println(employee);
        };
    io:println("\n========== OrderItem ==========");
    _ = check from rainier:OrderItem orderIt in rainierClient->/orderitems.get()
        do {
            io:println(orderIt);
        };
