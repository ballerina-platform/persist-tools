...
CREATE TABLE `Customer` (
	...
	CONSTRAINT FK_CUSTOMER_MULTIPLEASSOCIATIONS_MULTIPLE_ASSOCIATIONS FOREIGN KEY(`multipleassociationsId`) REFERENCES `MultipleAssociations`(`id`),
	PRIMARY KEY(`id`)
);
...
CREATE TABLE `Dept` (
	...
	`name` VARCHAR(191) NOT NULL,
	`multipleassociationsId` INT UNIQUE NOT NULL,
	CONSTRAINT FK_DEPT_MULTIPLEASSOCIATIONS_MULTIPLE_ASSOCIATIONS FOREIGN KEY(`multipleassociationsId`) REFERENCES `MultipleAssociations`(`id`),
	PRIMARY KEY(`id`)
);
