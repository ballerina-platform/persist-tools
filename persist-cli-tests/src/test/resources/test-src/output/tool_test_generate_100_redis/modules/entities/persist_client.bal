    ...
    private final record {|predis:RedisMetadata...;|} & readonly metadata = {
        [FOLLOW]: {
            ...
            fieldMetadata: {
                ...
                timestamp: {fieldName: "timestamp", fieldDataType: predis:CIVIL},
        ...
        [USER]: {
            ...
            fieldMetadata: {
                ...
                "posts[].timestamp": {relation: {entityName: "posts", refField: "timestamp", refFieldDataType: predis:CIVIL}},
                ...
                "comments[].timesteamp": {relation: {entityName: "comments", refField: "timesteamp", refFieldDataType: predis:CIVIL}},
                ...
                "followers[].timestamp": {relation: {entityName: "followers", refField: "timestamp", refFieldDataType: predis:CIVIL}},
                ...
                "following[].timestamp": {relation: {entityName: "following", refField: "timestamp", refFieldDataType: predis:CIVIL}}
            },
            keyFields: ["id"],
            refMetadata: {
        ...
        [COMMENT]: {
            ...
            fieldMetadata: {
                ...
                timesteamp: {fieldName: "timesteamp", fieldDataType: predis:CIVIL},
                userId: {fieldName: "userId", fieldDataType: predis:INT},
                ...
                "post.timestamp": {relation: {entityName: "post", refField: "timestamp", refFieldDataType: predis:CIVIL}},
