...
public isolated client class Client {
    *persist:AbstractPersistClient;
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            [MEDICAL_NEED] : check new (dbClient, self.metadata.get(MEDICAL_NEED), psql:MSSQL_SPECIFICS),
            [MEDICAL_ITEM] : check new (dbClient, self.metadata.get(MEDICAL_ITEM), psql:MSSQL_SPECIFICS)
        };
    }
