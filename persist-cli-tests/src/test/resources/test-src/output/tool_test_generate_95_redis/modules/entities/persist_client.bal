    ...
    private final record {|predis:RedisMetadata...;|} & readonly metadata = {
        ...
        [COMPOSITE_ASSOCIATION_RECORD]: {
            ...
            fieldMetadata: {
                id: {fieldName: "id", fieldDataType: predis:STRING},
                randomField: {fieldName: "randomField", fieldDataType: predis:STRING},
                alltypesidrecordBooleanType: {fieldName: "alltypesidrecordBooleanType", fieldDataType: predis:STRING},
                alltypesidrecordIntType: {fieldName: "alltypesidrecordIntType", fieldDataType: predis:STRING},
                alltypesidrecordFloatType: {fieldName: "alltypesidrecordFloatType", fieldDataType: predis:STRING},
                alltypesidrecordDecimalType: {fieldName: "alltypesidrecordDecimalType", fieldDataType: predis:STRING},
