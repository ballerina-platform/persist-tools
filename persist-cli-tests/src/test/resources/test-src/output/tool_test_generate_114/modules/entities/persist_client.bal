...
public isolated client class Client {
    *persist:AbstractPersistClient;
    ...
    private final record {|psql:SQLMetadata...;|} & readonly metadata = {
        ...
        [CONCEPT]: {
            ...
            fieldMetadata: {
                ...
                "codeSystem.version": {relation: {entityName: "codeSystem", refField: "version"}},
        ...
        [VALUE_SET_COMPOSE_INCLUDE]: {
            ...
            fieldMetadata: {
                ...
                "valueSet.version": {relation: {entityName: "valueSet", refField: "version"}},
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            [CODE_SYSTEM]: check new (dbClient, self.metadata.get(CODE_SYSTEM), psql:MYSQL_SPECIFICS),
            [CONCEPT]: check new (dbClient, self.metadata.get(CONCEPT), psql:MYSQL_SPECIFICS),
            [VALUE_SET]: check new (dbClient, self.metadata.get(VALUE_SET), psql:MYSQL_SPECIFICS),
            [VALUE_SET_COMPOSE_INCLUDE]: check new (dbClient, self.metadata.get(VALUE_SET_COMPOSE_INCLUDE), psql:MYSQL_SPECIFICS),
            [VALUE_SET_COMPOSE_INCLUDE_VALUE_SET]: check new (dbClient, self.metadata.get(VALUE_SET_COMPOSE_INCLUDE_VALUE_SET), psql:MYSQL_SPECIFICS),
            [VALUE_SET_COMPOSE_INCLUDE_CONCEPT]: check new (dbClient, self.metadata.get(VALUE_SET_COMPOSE_INCLUDE_CONCEPT), psql:MYSQL_SPECIFICS)
        };
    }
