...
public isolated client class Client {
    *persist:AbstractPersistClient;
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            [APPOINTMENT]: check new (dbClient, self.metadata.get(APPOINTMENT).cloneReadOnly(), psql:MSSQL_SPECIFICS),
            [PATIENT]: check new (dbClient, self.metadata.get(PATIENT).cloneReadOnly(), psql:MSSQL_SPECIFICS),
            [DOCTOR]: check new (dbClient, self.metadata.get(DOCTOR).cloneReadOnly(), psql:MSSQL_SPECIFICS)
        };
    }
