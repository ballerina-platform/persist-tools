...
public client class EntitiesClient {
    *persist:AbstractPersistClient;
    ...
    isolated resource function get vehicle() returns stream<Vehicle, persist:Error?> = external;
    isolated resource function get vehicle/[int model]() returns Vehicle|persist:Error = external;
    isolated resource function post vehicle(VehicleInsert[] data) returns int[]|persist:Error = external;
    isolated resource function put vehicle/[int model](VehicleUpdate value) returns Vehicle|persist:Error = external;
    isolated resource function delete vehicle/[int model]() returns Vehicle|persist:Error = external;
