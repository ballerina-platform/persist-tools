...
public client class FooClient {
    *persist:AbstractPersistClient;
    ...
    isolated resource function put building/[string buildingCode](Building value) returns Building|persist:Error = external;
    ...
    isolated resource function put department/[string deptNo](Department value) returns Department|persist:Error = external;
    ...
    isolated resource function put employee/[string empNo](Employee value) returns Employee|persist:Error = external;
    ...
    isolated resource function put workspace/[string workspaceId](Workspace value) returns Workspace|persist:Error = external;
