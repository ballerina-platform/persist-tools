    ...
    *persist:AbstractPersistClient;
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            ...
            [USER2]: check new (dbClient, self.metadata.get(USER2).cloneReadOnly(), psql:POSTGRESQL_SPECIFICS),
            [CAR2]: check new (dbClient, self.metadata.get(CAR2).cloneReadOnly(), psql:POSTGRESQL_SPECIFICS)
        };
    }
