...
public client class EntitiesClient {
    *persist:AbstractPersistClient;
    ...
    isolated resource function get medicalneed/[int 'record]() returns MedicalNeed|persist:Error = external;
    isolated resource function post medicalneed(MedicalNeedInsert[] data) returns int[]|persist:Error = external;
    isolated resource function put medicalneed/[int 'record](MedicalNeedUpdate value) returns MedicalNeed|persist:Error = external;
    isolated resource function delete medicalneed/[int 'record]() returns MedicalNeed|persist:Error = external;
    ...
    isolated resource function put medicalitem/[int itemId](MedicalItemUpdate value) returns MedicalItem|persist:Error = external;
