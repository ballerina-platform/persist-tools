...
public client class CompanyClient {
    ...
    private final map<persist:JoinMetadata> joinMetadata = {employee: {entity: Employee, fieldName: "employee", refTable: "Employees", refFields: [""], joinColumns: [""], 'type: persist:MANY}};
