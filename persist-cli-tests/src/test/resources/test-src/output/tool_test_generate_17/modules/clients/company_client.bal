...
// This file is an auto-generated script by Ballerina persistence layer for Company.
...
public client class CompanyClient {
    *persist:AbstractPersistClient;
    ...
    private final map<persist:FieldMetadata> fieldMetadata = {
        ...
        "employee[].id": {'type: int, relation: {entityName: "employee", refTable: "Employees", refField: "id"}},
        "employee[].name": {'type: string, relation: {entityName: "employee", refTable: "Employees", refField: "name"}}
    };
    private string[] keyFields = ["id"];

    private final map<persist:JoinMetadata> joinMetadata = {employee: {entity: Employee, fieldName: "employee", refTable: "Employees", refFields: ["id"], joinColumns: ["employeeId"], 'type: persist:MANY}};
